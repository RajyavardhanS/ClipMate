...
const Home = ({ theme }) => {
  ...
  // Calculate line count based on textarea value
  const lineCount = value.split("\n").length;

  // Dynamic styles for caret color and text color based on theme
  const caretColor = theme === "dark" ? "#fff" : "#000";
      ...
      <div className="flex flex-col gap-y-5 items-start">
        ...
        >
          ...
          <textarea
            ...
            style={{
              caretColor: caretColor, // Set caret color dynamically
